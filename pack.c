...
uint64_t pack(word unpacked_word)
{
        ...
        packed_result = Bitpack_newu(packed_result, 9, 23, unpacked_word->a);
        packed_result = Bitpack_news(packed_result, 5, 18, unpacked_word->b);
        packed_result = Bitpack_news(packed_result, 5, 13, unpacked_word->c);
        packed_result = Bitpack_news(packed_result, 5, 8, unpacked_word->d);
...
{
        unsigned a = Bitpack_getu(codeword, 9, 23);
        signed b = Bitpack_gets(codeword, 5, 18);
        signed c = Bitpack_gets(codeword, 5, 13);
        signed d = Bitpack_gets(codeword, 5, 8);
