...
struct Word DCT(UArray_T block)
{
        ...
        unsigned qa = (signed) scale_round(a, 511);
        signed qb = scale_round(b, 50);
        signed qc = scale_round(c, 50);
        signed qd = scale_round(d, 50);
...
UArray_T Word_to_CV(word unpacked_word)
{
        ...
        float a = (((float) (unpacked_word->a)) / 511);
        float b = (((float) (unpacked_word->b)) / 50);
        float c = (((float) (unpacked_word->c)) / 50);
        float d = (((float) (unpacked_word->d)) / 50);
